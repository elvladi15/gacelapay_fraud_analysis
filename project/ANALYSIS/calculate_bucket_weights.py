...
def get_bucket_weights_df(sql_file):
...
print(get_bucket_weights_df('project/SQL/BUCKETS/WEIGHT_CALCULATION_BUCKETS/MONTH.sql'))
print(get_bucket_weights_df('project/SQL/BUCKETS/WEIGHT_CALCULATION_BUCKETS/HOUR.sql'))
print(get_bucket_weights_df('project/SQL/BUCKETS/WEIGHT_CALCULATION_BUCKETS/MONTH+HOUR.sql'))